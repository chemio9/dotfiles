...
const BarResource = (name, icon, command) => {
  ...
  const widget = Box({
    ...
    children: [resourceLabel, resourceProgress],
    setup: (self) =>
      self.poll(5000, () =>
...
export default () => {
          ...
          child: Box({
            ...
            children: [
              ...
              BarResource(
                ...
                // `$(( 100- $(LANG=C top -bn1 | grep Cpu | awk '{print $8}') ))`,
                `awk 'BEGIN {print 100-'"$(LANG=C top -bn1 | grep Cpu | awk '{print $8}')"' }'`
              ),
            ],
          }),
          setup: (self) =>
  ...
  return Widget.EventBox({
    ...
    child: Box({
      ...
      children: [BarGroup({ child: musicStuff }), systemResources],
    }),
  });
};
